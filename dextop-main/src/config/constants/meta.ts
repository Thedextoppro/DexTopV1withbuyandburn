...
export const DEFAULT_META: PageMeta = {
  title: 'DexTop Finance',
  description:
    "DexTop is the next-generation DeFi innovation, brought to life on the PulseChain network. It's a cutting-edge token designed to blend advanced tokenomics with unparalleled utility.",
  image: 'https://dextop.pro/images/hero.png',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    ...
    defaultTitleSuffix: t('DexTop Finance'),
  }
}
