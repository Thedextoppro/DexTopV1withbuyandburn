...
import { bscTokens, bscTestnetTokens, pulseChainTokens, USDC, USDT, BUSD, WBTC_ETH } from '@pancakeswap/tokens'
...
export const LIMIT_ORDERS_DOCS_URL = 'https://docs.dextop.pro/products/pancakeswap-exchange/limit-orders'
