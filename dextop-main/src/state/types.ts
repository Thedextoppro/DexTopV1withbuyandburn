...
export interface SerializedNftUserData {
  allowance: string
  stakedBalanceByTier: number[]
  isExpiredByTier: number[]
  totalClaimedAmountByTier: number[]
  pendingRewardsByTier: string[]
...
export interface SerializedNft {
  userData?: SerializedNftUserData
  soldOutByTier: BigNumber[]
}
...
export interface LotteryRound extends LotteryRoundGenerics {
  ...
  priceTicketInXfn: BigNumber
  discountDivisor: BigNumber
  amountCollectedInXfn: BigNumber
  xfnPerBracket: string[]
  countWinnersPerBracket: string[]
  rewardsBreakdown: string[]
}

export interface LotteryResponse extends LotteryRoundGenerics {
  priceTicketInXfn: SerializedBigNumber
  discountDivisor: SerializedBigNumber
  amountCollectedInXfn: SerializedBigNumber
  xfnPerBracket: SerializedBigNumber[]
